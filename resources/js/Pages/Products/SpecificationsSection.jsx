    ...
    <div className="min-h-[400px]">
      ...
      {activeTab === "interior" && (
        <div>
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-brandBlue to-brandBlue rounded-full mx-auto mb-8"></div>
          ...
          {interiorImages.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {interiorImages.map((img, idx) => (
                <div
                  key={img.id ?? idx}
                  className="group rounded-2xl overflow-hidden shadow-xl border-2 border-gray-200 hover:border-brandBlue transition-all duration-500 hover:shadow-2xl bg-white"
                >
          ...
          {exteriorImages.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {exteriorImages.map((img, idx) => (
                <div
                  key={idx}
                  className="relative aspect-video rounded-2xl overflow-hidden shadow-xl group cursor-pointer border-2 border-gray-200 hover:border-brandBlue transition-all duration-500 hover:shadow-2xl"
                >
                  <img
                    src={img.url}
                    alt={`Exterior ${idx + 1}`}
          ...
          {galeriaImages.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {galeriaImages.map((img, idx) => (
                <div
                  key={idx}
                  className="relative aspect-square rounded-2xl overflow-hidden shadow-xl group cursor-pointer border-2 border-gray-200 hover:border-brandBlue transition-all duration-500 hover:shadow-2xl"
                >
                  <img
                    src={img.url}
                    alt={`Galería ${idx + 1}`}
